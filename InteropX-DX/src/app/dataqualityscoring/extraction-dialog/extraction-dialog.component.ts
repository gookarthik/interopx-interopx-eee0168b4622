...
export class ExtractionDialogComponent implements OnInit {
    ...
    constructor(public dialogRef: MatDialogRef<ExtractionDialogComponent>,
        @Inject(MAT_DIALOG_DATA) public data: any, private dataqualitybydservice: DataQualityByExtractionService) {
        console.log(data.dsres);
        this.dsName = data.dsres.dsName;
        const dsresponse = data.dsres;
    ...
    loadextractData(exdata) {
        ...
        this.dataqualitybydservice.getdsExtractionsByDsId(exdata.dsId).subscribe((res: Response) => {
