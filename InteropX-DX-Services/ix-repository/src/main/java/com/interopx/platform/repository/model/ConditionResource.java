...
public class ConditionResource {
	...
	@Column(name = "interopx_condition_id")
	private String interopxConditionId;
	...
	public String getInteropxConditionId() {
		return interopxConditionId;
	}

	public void setInteropxConditionId(String interopxConditionId) {
		this.interopxConditionId = interopxConditionId;
	}
