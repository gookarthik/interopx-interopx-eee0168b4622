...
public class LabResultsResource {
	...
	@Column(name = "interopx_lab_id")
	private String interopxLabId;

	@Column(name = "interopx_patient_id")
	private String interopxPatientId;

	@Column(name = "actual_lab_id")
	private String actualLabId;
	...
	public String getInteropxLabId() {
		return interopxLabId;
	}

	public void setInteropxLabId(String interopxLabId) {
		this.interopxLabId = interopxLabId;
	}
	...
	public String getActualLabId() {
		return actualLabId;
	}

	public void setActualLabId(String actualLabId) {
		this.actualLabId = actualLabId;
	}
