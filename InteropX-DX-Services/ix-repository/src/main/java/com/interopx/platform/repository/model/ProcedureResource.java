...
public class ProcedureResource {
	...
	@Column(name = "interopx_procedure_id")
	private String interopxProcedureId;

	@Column(name = "interopx_patient_id")
	private String interopxPatientId;

	@Column(name = "actual_procedure_id")
	private String actualProcedureId;
	...
	public String getInteropxProcedureId() {
		return interopxProcedureId;
	}

	public void setInteropxProcedureId(String interopxProcedureId) {
		this.interopxProcedureId = interopxProcedureId;
	}
	...
	public String getActualProcedureId() {
		return actualProcedureId;
	}

	public void setActualProcedureId(String actualProcedureId) {
		this.actualProcedureId = actualProcedureId;
	}
