...
public class MedicationResource {
	...
	@Column(name = "interopx_medication_id")
	private String interopxMedicationId;

	@Column(name = "interopx_patient_id")
	private String interopxPatientId;

	@Column(name = "actual_medication_id")
	private String actualMedicationId;
	...
	public String getInteropxMedicationId() {
		return interopxMedicationId;
	}

	public void setInteropxMedicationId(String interopxMedicationId) {
		this.interopxMedicationId = interopxMedicationId;
	}
	...
	public String getActualMedicationId() {
		return actualMedicationId;
	}

	public void setActualMedicationId(String actualMedicationId) {
		this.actualMedicationId = actualMedicationId;
	}
